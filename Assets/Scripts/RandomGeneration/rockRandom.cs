...
public class rockRandom : MonoBehaviour {
	...
	void Start () {
		...
		myList.Add(new Vector3(32,24 +UnityEngine.Random.value*15, 65 ));
		myList.Add(new Vector3(50,24 +UnityEngine.Random.value*15, 67 ));
		myList.Add(new Vector3(85,24 +UnityEngine.Random.value*15, 76 ));
		myList.Add(new Vector3(15,24 +UnityEngine.Random.value*15, 67 ));
		...
		myList.Add(new Vector3(92,16 +UnityEngine.Random.value*15, 48 ));
		myList.Add(new Vector3(9,16 +UnityEngine.Random.value*15, 50 ));
		...
		myList.Add(new Vector3(91,14 +UnityEngine.Random.value*15, 18 ));
		myList.Add(new Vector3(62,15 +UnityEngine.Random.value*15, 54 ));
		myList.Add(new Vector3(7,14 +UnityEngine.Random.value*15, 6 ));
