...
public class parkRandom : MonoBehaviour {
	...
	void Start () {
		...
		myList.Add(new Vector3(11,6 +UnityEngine.Random.value*15, 35 ));
		myList.Add(new Vector3(75,6 +UnityEngine.Random.value*15, 68 ));

		myList.Add(new Vector3(53,6+UnityEngine.Random.value*15, 78 ));
		myList.Add(new Vector3(75,6+UnityEngine.Random.value*15, 72 ));
		myList.Add(new Vector3(33,6 +UnityEngine.Random.value*15, 15 ));
		myList.Add(new Vector3(18,6 +UnityEngine.Random.value*15, 55 ));
		myList.Add(new Vector3(23,6 +UnityEngine.Random.value*15, 67 ));
		myList.Add(new Vector3(7,6 +UnityEngine.Random.value*15, 6 ));
